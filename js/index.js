...
const mapConfigs = {
  ...
  map2: {
    ...
    monsters: [
      { x: 200, y: 200, size: 15, imageSrc: './images/Snake.png', sprites: monsterSprites },
      { x: 350, y: 180, size: 15, imageSrc: './images/Snake.png', sprites: monsterSprites },
      { x: 500, y: 300, size: 15, imageSrc: './images/Snake.png', sprites: monsterSprites },
      { x: 280, y: 400, size: 15, imageSrc: './images/Snake.png', sprites: monsterSprites },
      { x: 450, y: 450, size: 15, imageSrc: './images/Snake.png', sprites: monsterSprites },
      { x: 150, y: 350, size: 15, imageSrc: './images/Snake.png', sprites: monsterSprites },
      { x: 600, y: 250, size: 15, imageSrc: './images/Snake.png', sprites: monsterSprites },
    ],
  },
  map3: {
    rows: 60,
    ...
    monsters: [
      { x: 356, y: 468, size: 15, imageSrc: './images/Bear.png', sprites: monsterSprites },
      { x: 356, y: 212, size: 15, imageSrc: './images/mushroom.png', sprites: monsterSprites },
      { x: 292, y: 212, size: 15, imageSrc: './images/Bear.png', sprites: monsterSprites },
      { x: 260, y: 404, size: 15, imageSrc: './images/mushroom.png', sprites: monsterSprites },
      { x: 628, y: 292, size: 15, imageSrc: './images/Bear.png', sprites: monsterSprites },
      { x: 436, y: 612, size: 15, imageSrc: './images/mushroom.png', sprites: monsterSprites },
      { x: 100, y: 404, size: 15, imageSrc: './images/Bear.png', sprites: monsterSprites },
      { x: 596, y: 228, size: 15, imageSrc: './images/mushroom.png', sprites: monsterSprites },
      { x: 564, y: 660, size: 15, imageSrc: './images/Bear.png', sprites: monsterSprites },
      { x: 356, y: 292, size: 15, imageSrc: './images/mushroom.png', sprites: monsterSprites },
      { x: 676, y: 388, size: 15, imageSrc: './images/Bear.png', sprites: monsterSprites },
      { x: 292, y: 340, size: 15, imageSrc: './images/mushroom.png', sprites: monsterSprites },
      { x: 564, y: 356, size: 15, imageSrc: './images/Bear.png', sprites: monsterSprites },
      { x: 228, y: 164, size: 15, imageSrc: './images/mushroom.png', sprites: monsterSprites },
      { x: 372, y: 724, size: 15, imageSrc: './images/Bear.png', sprites: monsterSprites },
    ],
  },
}
